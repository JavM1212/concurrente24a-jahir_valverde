...
/**
 * @brief analyze command line arguments
 * 
 * @param argc count of arguments given in terminal
 * @param argv array of arguments given in terminal
 * @return onsuccess: int diferente de 0
 *         onfailure: int con el valor 0 (failure incluye el caso de que
 *         el usuario ponga que quiere 0 hilos)
 */
